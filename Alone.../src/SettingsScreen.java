...
public class SettingsScreen extends GameObject {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("GAME CREATED BY ADRIAN ENSAN, ZAHEEN CHOUDHRY", (int) (width - g.getFontMetrics(game.getFont().deriveFont(16f)).stringWidth("GAME CREATED BY ADRIAN ENSAN, ZAHEEN CHOUDHRY")) / 2, game.WINDOW_HEIGHT - 20);
    }
}
